...
namespace MH.WaterCausticsModules {
    public class Constant {
        ...
        public const string REQUIRE_URP_VER = "10.4 or higher";
        ...
        public const string WCE_VERSION_STR = "2.1.4"; // アセットバージョン ※下のWCE_VERSION_INTと合わせること
        public const int WCE_VERSION_INT = 20104; // アセットバージョン
